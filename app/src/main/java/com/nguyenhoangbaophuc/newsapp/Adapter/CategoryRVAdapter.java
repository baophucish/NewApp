...
public class CategoryRVAdapter extends RecyclerView.Adapter<CategoryRVAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull CategoryRVAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.categoryTV.setText(categoryRVModel.getCategoryShow());

        Glide.with(context)
                .load(getDrawableResID(categoryRVModel.getCategoryImage()))
    ...
    private int getDrawableResID(String imageCategory){
        return context.getResources().getIdentifier(imageCategory,"drawable", context.getPackageName());
    }
